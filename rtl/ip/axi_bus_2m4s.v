module axi_bus_m2s4
      #(parameter WIDTH_CID   = 4 // Channel ID width in bits
                ...
                `endif
                , SLAVE_EN0   = 1 , ADDR_BASE0  =32'h00000000 , ADDR_LENGTH0=29 // effective address bits
                , SLAVE_EN1   = 1 , ADDR_BASE1  =32'h80000000 , ADDR_LENGTH1=24 // effective address bits
                , SLAVE_EN2   = 1 , ADDR_BASE2  =32'hF0000000 , ADDR_LENGTH2=24 // effective address bits
                , SLAVE_EN3   = 1 , ADDR_BASE3  =32'hF8000000 , ADDR_LENGTH3=24 // effective address bits
